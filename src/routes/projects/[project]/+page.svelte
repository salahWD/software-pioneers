<script>
	...
	export let data = {
		...
		aboutTheClientTitle: 'About The Client',
		aboutTheClientDescription:
		...
		aboutTheClientImg: 'https://images.unsplash.com/photo-1569144157591-c60f3f82f137',
		theProplemTitle: 'Problem Facing !',
		theProplemDescription: 'the problem he faced was that he',
		theProplemImg: 'https://images.unsplash.com/photo-1599134842279-fe807d23316e',
		solutionTitle: 'Our Solution Offer',
		solutionDescription:
			'weh have though that by changing the platform the client has and making it faster it can reduse the percentage of users leaving the website before loading and users that do not interact with the platform as intended',
		solutionImg: 'https://images.unsplash.com/photo-1599134842279-fe807d23316e'
	};
</script>
				...
				<div>
					...
					<div class="mt-6">
						<h2 class="text-3xl font-bold tracking-tight text-white">
							{$t(data.aboutTheClientTitle)}
						</h2>
						<p class="mt-4 text-lg text-gray-300">
							{$t(data.aboutTheClientDescription)}
						</p>
						<div class="mt-6">
							<a
		...
		>
			<div class="mx-auto max-w-xl px-6 lg:mx-0 lg:max-w-none lg:py-16 lg:px-0 lg:col-start-2">
				<div>
					...
					<div class="mt-6">
						<h2 class="text-3xl font-bold tracking-tight text-white">{$t(data.theProplemTitle)}</h2>
						<p class="mt-4 text-lg text-gray-300">
							{$t(data.theProplemDescription)}
						</p>
						<div class="mt-6">
							<a
		...
		>
			<div class="mx-auto max-w-xl px-6 lg:mx-0 lg:max-w-none lg:py-16 lg:px-0">
				<div>
					...
					<div class="mt-6">
						<h2 class="text-3xl font-bold tracking-tight text-white">
							{$t(data.solutionTitle)}
						</h2>
						<p class="mt-4 text-lg text-gray-300">
							{$t(data.solutionDescription)}
						</p>
						<div class="mt-6">
							<a
								class="capitalize inline-flex rounded-lg bg-pink-600 px-4 py-1.5 text-base font-semibold leading-7 text-white shadow-sm ring-1 ring-pink-600 hover:bg-pink-700 hover:ring-pink-700"
